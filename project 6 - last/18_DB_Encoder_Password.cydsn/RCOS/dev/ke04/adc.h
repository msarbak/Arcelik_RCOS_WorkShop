/** @file       ke04/adc.h
 *  @brief      Analog-Digital Converter device driver for NXP KE04
...
/**
 *  @defgroup   KE04_ADC ADC
 *  @ingroup    KE04_DEV_IO
 *  @brief      NXP KE04 Analog-Digital Converter device driver
 *  @{
 */
...
/** @defgroup   KE04_ADC_CORE ADC_CORE
...
typedef struct
{
    const tsAdcCoreConstParams *constants; ///< Contant parameters of ADC_CORE
 ...
 *  @param  _source         Clock source of ADC module (0 - 3)
 *  @param  _divider        Clock divider of ADC module (1, 2, 4 or 8)
 *  @param  _longSample     Long sampling time for ADC module (0: Disabled, 1: Enabled)
    ...
    const tsAdcCoreConstParams _name##ConstParams =                               \
        {                                                                         \
            {                                                                     \
                ...
                0,                                     /*enableLowPower*/         \
                _longSample,                           /*enableLongSampleTime*/   \
                kADC_ClockDivider##_divider,           /*clockDivider*/           \
                kADC_Resolution##_resolution##BitMode, /*ResolutionMode*/         \
                kADC_ClockSourceAlt##_source,          /*clockSource*/            \
            },                                                                    \
            _nxpDev,                                                              \
            _name##ChList,                                                        \
            _name##ChValues,                                                      \
