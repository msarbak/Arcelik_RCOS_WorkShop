/** @file       ke15/platform.c
 *  @brief      Platform specific modifications for KE15
...
#ifndef RCOS_PLATFORM_KE15
#error this file is prepared for KE15 only
#endif
...
{
    ADD_RCOS_VERSION("ke15/platform", "2.0.2")
}
