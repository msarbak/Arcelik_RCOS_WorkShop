/** @file       ke04/platform.h
 *  @brief      Platform specific modifications for NXP KE04
 ...
 *  @defgroup   KE04 KE04
 *  @ingroup    PLATFORM
 *  @brief      NXP KE04 family cpu devices
 *  @{
 *      @defgroup   KE04_DEV_IO DEV_IO
 *      @defgroup   KE04_DEV_COM DEV_COM
 *      @defgroup   KE04_DEV_MEM DEV_MEM
 *      @defgroup   KE04_DEV_CPX DEV_CPX
 */
