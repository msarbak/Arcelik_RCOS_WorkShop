/** @file       sc_spi_sl.h
 *  @brief      Serial Communication Protocol over SPI Slave
 ...
 *  @date       24.07.2019
 */
#ifndef FILE_SC_SPI_SL_H
#define FILE_SC_SPI_SL_H

/**
 *  @defgroup   SC_SPI_SL SC_SPI_SL
 *  @ingroup    MW
 *  @brief      Serial Communication Protocol over SPI Slave
 *  @{
 */
...
/// @brief  Events of a ScSpiSl process
typedef enum
{
 ...
 *  EXPORTED MACROS
 */
/** @brief  ScSpiSl process object creation macro
 ...
 */
#define PROCESS_SC_SPI_SL_CREATE(_name, _enum, _devCom, _devComTarget, _mapName, _queueSize) \
    DEQUE_CREATE(_name##Que, _queueSize)                                                     \
    tsScSpiSlParams _name##Params =                                                          \
        {                                                                                    \
    ...
    PROCESS_CREATE(_name, scSpiSlInit, scSpiSlDeinit, _enum, &_name##Params, NULL)

/*********************************************************************
 *  INTERFACES
 */

#ifndef FILE_SC_SPI_SL_C
