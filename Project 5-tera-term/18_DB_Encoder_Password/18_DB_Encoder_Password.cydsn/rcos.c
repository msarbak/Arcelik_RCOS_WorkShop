...
DEV_COM_UART_CREATE(mmtUart ,cyUart_p50_p51)
// Encoder password process create macro
PROCESS_ENCODERPASSWORD_CREATE(encoderPassword, eProcessEncoderPassword, ledP43, ledP44, ledP45, sevenSegmentDisplay, encoder, patternBuzzer ,mmtUart)
