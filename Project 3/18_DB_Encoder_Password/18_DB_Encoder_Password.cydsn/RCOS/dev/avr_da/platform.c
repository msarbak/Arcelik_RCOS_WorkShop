/** @file       ke04/platform.c
 *  @brief      Platform specific modifications for AVR_DA
...
#ifndef RCOS_PLATFORM_AVR_DA
#error this file is prepared for AVR DA only
#endif
...
{
    ADD_RCOS_VERSION("avr_da/platform", "1.1.2")
    globalIntEnable();
}
