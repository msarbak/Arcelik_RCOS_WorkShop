...
/**
 *  @defgroup   KE14_FLASH FLASH
 *  @ingroup    KE14_DEV_CPX
 *  @brief      NXP KE14 Flash access
 *  @{
 */
...
/** @brief  Create a devCpx object to access internal flash of NXP KE14
...
/**
 *  @defgroup   KE14_EEPROM EEPROM
 *  @ingroup    KE14_DEV_MEM
 *  @ingroup    KE14_FLASH
 *  @brief      NXP KE14 internal EEPROM
 *  @{
 */
...
/** @brief  Create a devMem object for EEPROM of KE14
...
/**
 *  @defgroup   KE14_SECTION SECTION
 *  @ingroup    KE14_DEV_MEM
 *  @ingroup    KE14_FLASH
 *  @brief      NXP KE14 Flash section as a devMem
 *  @{
 */
...
/** @brief      Create a devMem object for a SECTION of KE14
