/** @file       ke14/platform.c
 *  @brief      Platform specific modifications for KE14
...
#ifndef RCOS_PLATFORM_KE14
#error this file is prepared for KE14 only
#endif
...
{
    globalIntDisable();
    ADD_RCOS_VERSION("ke14/platform", "2.0.2")
