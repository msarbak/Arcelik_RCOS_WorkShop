/** @file       ke16/adc.h
 *  @brief      Analog-Digital Converter device driver for NXP KE16
...
/**
 *  @defgroup   KE16_ADC ADC
 *  @ingroup    KE16_DEV_IO
 *  @brief      NXP MKE16 Analog-Digital Converter device driver
 *  @{
 */
...
/** @defgroup   KE16_ADC_CORE ADC_CORE
